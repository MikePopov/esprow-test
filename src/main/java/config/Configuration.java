...
/**
 * This interface loads the global parameters contained within
...
public interface Configuration extends Config {
   ...
   *
   * @return a boolean containing the choice whether the browser will run in
   *         headless mode
   */
  @Key("headless")
  Boolean headless();
  ...
  /**
   * Associates the property 'base.test.data.path' with the baseTestDataPath()
   * method.
   *
  ...
  /**
   * Associates the property 'base.screenshot.path' with the baseScreenshotPath()
   * method.
   *
   * @return a string containing the base path to store all the failed test
   *         screenshots
   */
